import { FaCheck, FaToggleOff, FaTrash } from "react-icons/fa6";
...
const TodoItem = ({todo,index}) => {
  ...
  return (
    <li className="flex flex-col sm:flex-row sm:items-center justify-between border-b-2 py-2 gap-4 text-white">
